export const NAME_APP_LONG = "INOUT - Inventory Management";
export const NAME_APP_SHORT = "INOUT";
export const DESCRIPTION_APP = "Inventory Management";
...
export const SIDEBAR_BACKGROUND_COLOR = '#F1F3F4'; 
